...
function load(opts){
  ...
  const sandbox = {
    ...
    MailApp: { sendEmail: (to, subject, body) => { env.outbox.push({ to: to, subject: subject, body: body }); } },
    GmailApp: { sendEmail: (to, subject, body) => { env.outbox.push({ to: to, subject: subject, body: body }); } },
    DriveApp: {
