...
const CAPTION = {
  ...
  'console-advisory-history': ['Every circular, still on the console',
    'Publishing a new circular retires the standing one; it has never deleted it. The whole history is here, each line carrying the tally it collected, and any of them opens.'],
  'console-advisory-retired': ['A retired circular, reopened',
    'The register is rebuilt against the circular asked for — who was addressed, who acknowledged it, and when. Retiring a circular takes nothing away.'],
